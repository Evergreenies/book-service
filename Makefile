...
alembic-auto-revision:
	${PYTHON} -m alembic revision --autogenerate -m "some random message"
...
help:
	...
	@echo "  alembic-init        : Initialize alembic migrations"
	@echo "  alembic-auto-revision        : Autogenerate alembic revision"
